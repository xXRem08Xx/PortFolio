...
<body>
  ...
  <section class="section pt-5">
    <div class="container">
      <div class="row">
        <div class="col-md-8">
          <p>Étudiant en BTS SIO 🤓, je me forme pour acquérir des compétences dans le domaine du Web design et de la programmation Logiciel 🖥️
            afin de pouvoir entrer dans la vie active. </p>

          <p>Passionné par l’intelligence artificielle 😍 et les jeux vidéo 🎮, je souhaite m’orienter dans un domaine permettant de regrouper et de pratiquer les 2 activités. 💪</p>
          <p>Je suis également un grand lecteur, et mes thèmes de livre préféré sont :

          <ul>
            <li>Fantasy (voyage dans le temps, dans d'autre univers ...)</li>
            <li>Science-Fiction (Monde virtuel, Mythologie)</li>
            <li>Manga (il n’y a rien à dire de plus sur ce thème 😉)</li>
          </ul>
          </p>
          <p>
            Mes collections de livres préférés sont :
          <ul>
